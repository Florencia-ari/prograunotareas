#include "Tablero.h"
//incluye archivos para la manipulación de cadenas de texto y operaciones de entrada y salida.
#include <sstream>
#include <iostream>

using namespace std;

//Clase tablero: constructores
//crea un tablero vacío con dimensiones aleatorias
Tablero::Tablero()
{
}
//crea el tablero con dimensiones especificas y un modo desarrollador que es opcional
Tablero::Tablero(int alturaTablero, int anchoTablero, bool modoDesarrollador)
{
	//Propiedades
	//Almacen de altura y ancho del tablero
    this->alturaTablero = alturaTablero;
    this->anchoTablero = anchoTablero;
    //indicar si el modo desarrollador esta activo o no
...
//Metodos get y set que permiten obtener y establecer la altura, ancho y modo desarrolador del tablero
...
//Representacion de una celda en el tablero
...
//Calcula el numero de minas cercanas a una celda en particular
...
//Imprimir el tablero en la consola con los elementos visuales adecuados, como las lineas de separacion y los numeros de fila y columna
void Tablero::imprimirSeparadorEncabezado()
	...
	//Colocar una mina en una celda específica y revelar si una celda tiene una mina o no.
	...
	//Contar el numero de celdas que no tienen minas y aun no han sido descubiertas en el tablero.
